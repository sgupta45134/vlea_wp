...
class Skin_Modal extends Elementor_Skin_Base {
	...
	protected function render_text() {		
		...
		$this->parent->add_render_attribute('button-icon', 'class', ['bdt-modal-button-icon', 'elementor-button-icon', 'bdt-button-icon-align-' . esc_attr($this->get_instance_value('modal_button_icon_align'))]);
