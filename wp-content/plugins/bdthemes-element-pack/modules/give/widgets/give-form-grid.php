...
class Give_Form_Grid extends Module_Base {
	...
	public function get_icon() {
		return 'bdt-wi-give-form-grid bdt-new';
	}
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-give-form-grid .give-wrap .give-grid.give-grid--best-fit' => 'display: grid;
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-give-form-grid .give-wrap .give-grid.give-grid--best-fit' => 'grid-gap: {{SIZE}}px;',
				],
			]
		);
