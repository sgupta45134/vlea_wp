<?php
namespace ElementPack\Modules\Give\Widgets;
...
class Give_Login extends Module_Base {
	...
	public function get_icon() {
		return 'bdt-wi-give-login bdt-new';
	}
	...
	private function render_editor_content() {
		...
		<form id="give-login-form" class="give-form">
			<fieldset>
				<legend><?php echo esc_html('Log into Your Account', 'bdthemes-element-pack'); ?></legend>
				...
				<div class="give-login-password give-login">
					<label for="give_user_pass">
						<?php echo esc_html('Password', 'bdthemes-element-pack'); ?>
					</label>
				...
				<div class="give-lost-password give-login">
					...
					<?php echo esc_html('Reset Password', 'bdthemes-element-pack'); ?></a>
				</div>
			</fieldset>
		</form>
        <?php
