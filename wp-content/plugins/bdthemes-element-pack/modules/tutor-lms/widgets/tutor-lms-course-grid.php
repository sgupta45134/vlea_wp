...
class Tutor_Lms_Course_Grid extends Module_Base {
	private $_query = null;
	...
	public function render_header() {
		...
		$this->add_render_attribute('courses', 'class', 'bdt-child-width-1-'. $settings['columns_mobile']);
		$this->add_render_attribute('courses', 'class', 'bdt-child-width-1-'. $settings['columns_tablet'] .'@s');
		$this->add_render_attribute('courses', 'class', 'bdt-child-width-1-'. $settings['columns'] .'@m');
