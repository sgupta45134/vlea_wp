...
class Timeline extends Module_Base {
    ...
    public function get_style_depends() {
        if ($this->ep_is_edit_mode()) {
            ...
            return ['ep-timeline', 'element-pack-font'];
        }
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .bdt-timeline .bdt-timeline-icon svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .bdt-timeline .bdt-timeline-icon span:before, {{WRAPPER}} .bdt-timeline .bdt-timeline-icon span' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'icon_show' => 'yes',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .bdt-timeline .bdt-timeline-icon span:hover:before, {{WRAPPER}} .bdt-timeline .bdt-timeline-icon span:hover i' => 'color: {{VALUE}} !important;',
                    '{{WRAPPER}} .bdt-timeline .bdt-timeline-icon span:hover svg'                                                               => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .bdt-timeline .bdt-timeline-readmore:hover svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
    ...
    public function render_item($item_parallax, $align, $item = []) {
        ...
        ?>
      <div class="bdt-timeline-item-main"<?php echo esc_attr($item_parallax); ?>>
    ...
    public function render_date($align = 'left', $item = []) {
      ...
      <div class="bdt-timeline-item bdt-width-1-2@m bdt-visible@m">
        <div class="bdt-timeline-date bdt-text-<?php echo esc_attr($align); ?>"<?php echo esc_attr($date_parallax); ?>>
          <span><?php echo esc_attr($timeline_date); ?></span></div>
      </div>
        <?php
                ...
                while ( $wp_query->have_posts() ) : $wp_query->the_post();
                  ...
                  <div
                    ...
                    <div class="bdt-timeline-item-main-wrapper">
                      <div class="bdt-timeline-line"><span<?php echo esc_attr($vertical_line_parallax); ?>></span></div>
                      <div class="bdt-timeline-item-main-container">
                        <div
                            class="bdt-timeline-icon bdt-post-format-<?php echo esc_attr($post_format); ?>"<?php echo esc_attr($icon_parallax); ?>>
                          <span></span>
                        </div>
