...
class Portfolio_Carousel extends Module_Base {
    ...
    private function register_section_controls()
    {
		...
		$this->register_navigation_style_controls( 'portfolio-carousel');
    ...
    public function render_header($skin = "default") {
        ...
        $this->add_render_attribute('carousel', 'class', ['bdt-portfolio-carousel', 'bdt-portfolio-carousel-skin-' . $skin]);
