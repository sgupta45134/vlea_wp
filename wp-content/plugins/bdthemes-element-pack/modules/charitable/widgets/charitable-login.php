<?php
namespace ElementPack\Modules\Charitable\Widgets;
...
class Charitable_Login extends Module_Base {
	...
	public function get_icon() {
		return 'bdt-wi-charitable-login bdt-new';
	}
    ...
    private function render_editor_content() {
		...
		<div class="charitable-login-form">
            ...
            <p>
                <a href="http://yoursite.com/wp-login.php?action=register&amp;redirect_to"><?php echo $registration_link_text; ?></a>&nbsp;|&nbsp;
                <a href="http://yoursite.com/wp-login.php?action=lostpassword"><?php echo esc_html('Forgot Password', 'bdthemes-element-pack'); ?></a>
            </p>
        </div>
        <?php
	}
