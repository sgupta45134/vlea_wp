...
class Air_Pollution extends Module_Base
{
    ...
    {
        return 'bdt-wi-air-pollution bdt-new';
    }
                ...
                <li class="bdt-flex bdt-flex-between  bdt-flex-middle bdt-padding-small">
                    ...
                    <div>
                        <span class="bdt-text-default bdt-text-normal bdt-ap-value">
                            <?php if(!empty($data)){ echo esc_html($data['components']['co']);} ?>
                        </span>
                    </div>
                </li>
                <li class="bdt-flex bdt-flex-between  bdt-flex-middle bdt-padding-small">
                    ...
                    <div>
                        <span class="bdt-text-default bdt-text-normal bdt-ap-value">
                            <?php if(!empty($data)){ echo esc_html($data['components']['no']);} ?>
                        </span>
                    </div>
                </li>
                <li class="bdt-flex bdt-flex-between  bdt-flex-middle bdt-padding-small">
                    ...
                    <div>
                        <span class="bdt-text-default bdt-text-normal bdt-ap-value">
                            <?php if(!empty($data)){ echo esc_html($data['components']['no2']);} ?>
                         </span>
                    </div>
                </li>
                <li class="bdt-flex bdt-flex-between  bdt-flex-middle bdt-padding-small">
                    ...
                    <div>
                        <span class="bdt-text-default bdt-text-normal bdt-ap-value">
                            <?php if(!empty($data)){ echo esc_html($data['components']['o3']);} ?>    
                        </span>
                    </div>
                </li>
                <li class="bdt-flex bdt-flex-between  bdt-flex-middle bdt-padding-small">
                    ...
                    <div>
                        <span class="bdt-text-default bdt-text-normal bdt-ap-value">
                             <?php if(!empty($data)){ echo esc_html($data['components']['so2']);} ?>  
                        </span>
                    </div>
                </li>
                <li class="bdt-flex bdt-flex-between  bdt-flex-middle bdt-padding-small">
                    ...
                    <div>
                        <span class="bdt-text-default bdt-text-normal bdt-ap-value">
                            <?php if(!empty($data)){ echo esc_html($data['components']['pm2_5']);} ?>  
                        </span>
                    </div>
                </li>
                <li class="bdt-flex bdt-flex-between  bdt-flex-middle bdt-padding-small">
                    ...
                    <div>
                        <span class="bdt-text-default bdt-text-normal bdt-ap-value">
                           <?php if(!empty($data)){ echo esc_html($data['components']['pm10']);} ?>  
                        </span>
                    </div>
                </li>
                <li class="bdt-flex bdt-flex-between  bdt-flex-middle bdt-padding-small">
                    ...
                    <div>
                        <span class="bdt-text-default bdt-text-normal bdt-ap-value">
                            <?php if(!empty($data)){ echo esc_html($data['components']['nh3']);} ?>  
                        </span>
                    </div>
                </li>
            </ul>
