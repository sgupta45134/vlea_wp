...
class Skin_Alice extends Elementor_Skin_Base {
	...
	public function render_image($image_id, $size) {
		...
		<?php else : ?>
			<div class="bdt-carousel-background"></div>
	...
	public function render_date() {
		?>
		<span class="bdt-carousel-date bdt-transition-slide-bottom"><?php echo apply_filters( 'the_date', get_the_date( get_option( 'date_format' ) ), '', '' ); ?></span>
		<?php 
	}
