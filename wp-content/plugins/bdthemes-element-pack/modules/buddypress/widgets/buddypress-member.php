				...
				<div class="bdt-grid bdt-grid-small bdt-text-<?php echo esc_attr($settings['align']); ?> bdt-flex-<?php echo esc_attr($settings['align']); ?>" bdt-grid>
					<?php while ( bp_members() ) : bp_the_member(); ?>
						...
						if ('auto' !== $settings['columns']) {
							$this->add_render_attribute('bp-member', 'class', 'bdt-width-1-'. $settings['columns_mobile']);
							$this->add_render_attribute('bp-member', 'class', 'bdt-width-1-'. $settings['columns_tablet'] .'@s');
							$this->add_render_attribute('bp-member', 'class', 'bdt-width-1-'. $settings['columns'] .'@m');
						} else {
