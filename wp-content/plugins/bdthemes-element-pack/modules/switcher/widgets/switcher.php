	...
	protected function _register_controls() {
		...
		$this->add_control(
		    ...
		    [
			    ...
			    'raw' => __( 'Note: Please insert two widgets on the same section then place your widgets id here. You must use Link widget option on both switcher. This result will visible on the Frontend.', 'bdthemes-element-pack' ),
