	...
	class Total_Count extends Module_Base {
		...
		protected function _register_controls() {
			...
			$this->add_responsive_control(
				...
				[
					'label'          => esc_html__( 'Icon / Image Vertical Offset', 'bdthemes-element-pack' ),
			...
			$this->add_responsive_control(
				...
				[
					'label'          => esc_html__( 'Icon / Image Horizontal Offset', 'bdthemes-element-pack' ),
					'type'           => Controls_Manager::SLIDER,
					'range'          => [
						'px' => [
							'min' => - 200,
					...
					'selectors'      => [
						'(desktop){{WRAPPER}} .bdt-total-count-icon' => 'transform: translate({{top_icon_horizontal_offset.SIZE}}{{UNIT}}, -{{top_icon_vertical_offset.SIZE}}px);',
						'(tablet){{WRAPPER}} .bdt-total-count-icon'  => 'transform: translate({{top_icon_horizontal_offset_tablet.SIZE}}{{UNIT}}, -{{top_icon_vertical_offset_tablet.SIZE}}px);',
						'(mobile){{WRAPPER}} .bdt-total-count-icon'  => 'transform: translate({{top_icon_horizontal_offset_mobile.SIZE}}{{UNIT}}, -{{top_icon_vertical_offset_mobile.SIZE}}px);',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors'      => [
						'(desktop){{WRAPPER}} .bdt-total-count-icon' => 'transform: translate({{left_right_icon_horizontal_offset.SIZE}}{{UNIT}}, {{left_right_icon_vertical_offset.SIZE}}{{UNIT}});',
						'(tablet){{WRAPPER}} .bdt-total-count-icon'  => 'transform: translate({{left_right_icon_horizontal_offset_tablet.SIZE}}{{UNIT}}, {{left_right_icon_vertical_offset_tablet.SIZE}}{{UNIT}});',
						'(mobile){{WRAPPER}} .bdt-total-count-icon'  => 'transform: translate({{left_right_icon_horizontal_offset_mobile.SIZE}}{{UNIT}}, {{left_right_icon_vertical_offset_mobile.SIZE}}{{UNIT}});',
					],
				]
			);
