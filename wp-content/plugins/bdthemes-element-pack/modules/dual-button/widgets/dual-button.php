...
class DualButton extends Module_Base {
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-a' => 'margin-right: {{SIZE}}px;',
				],
				'condition' => [
					'show_middle_text!' => 'yes',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-a, 
								{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-a.bdt-ep-button-effect-i .bdt-ep-button-content-wrapper:after,
								{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-a.bdt-ep-button-effect-i .bdt-ep-button-content-wrapper:before',
				'separator' => 'after',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#666',
				'selectors' => [
					'{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-a' => 'border-color: {{VALUE}};',
				],
				'condition' => [
					'button_border_style!' => 'none'
				]
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'types'     => [ 'classic', 'gradient' ],
				'selector'  => '{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-a:after, 
								{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-a:hover,
								{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-a.bdt-ep-button-effect-i,
								{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-a.bdt-ep-button-effect-h:after',
				'separator' => 'after',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-a:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-a:hover' => 'border-color: {{VALUE}};',
				],
				'condition' => [
					'button_border_style!' => 'none'
				]
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-b' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'types'    => [ 'classic', 'gradient' ],
				'selector' => '{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-b, 
							   {{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-b.bdt-ep-button-effect-i .bdt-ep-button-content-wrapper:after, 
							   {{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-b.bdt-ep-button-effect-i .bdt-ep-button-content-wrapper:before',
				'separator' => 'after',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-b' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#666',
				'selectors' => [
					'{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-b' => 'border-color: {{VALUE}};',
				],
				'condition' => [
					'button_border_style!' => 'none'
				]
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-b:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'types'     => [ 'classic', 'gradient' ],
				'selector'  => '{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-b:after,
								{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-b:hover, 
								{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-b.bdt-ep-button-effect-i,
								{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-b.bdt-ep-button-effect-h:after
								',
				'separator' => 'after',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-b:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bdt-ep-button-wrapper .bdt-dual-button-b:hover' => 'border-color: {{VALUE}};',
				],
				'condition' => [
					'button_border_style!' => 'none'
				]
		...
		$this->add_group_control(
			...
			[
				...
				'types'     => [ 'classic', 'gradient' ],
				'selector'  => '{{WRAPPER}} .bdt-ep-button .bdt-dual-button-a-icon .bdt-ep-button-a-icon-inner',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .bdt-ep-button .bdt-dual-button-a-icon .bdt-ep-button-a-icon-inner' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .bdt-ep-button .bdt-dual-button-a-icon .bdt-ep-button-a-icon-inner' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-ep-button .bdt-dual-button-a-icon .bdt-ep-button-a-icon-inner' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'types'     => [ 'classic', 'gradient' ],
				'selector'  => '{{WRAPPER}} .bdt-ep-button:hover .bdt-dual-button-a-icon .bdt-ep-button-a-icon-inner',
				'separator' => 'after',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-ep-button:hover .bdt-dual-button-a-icon .bdt-ep-button-a-icon-inner' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'types'     => [ 'classic', 'gradient' ],
				'selector'  => '{{WRAPPER}} .bdt-ep-button .bdt-dual-button-b-icon .bdt-ep-button-b-icon-inner',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .bdt-ep-button .bdt-dual-button-b-icon .bdt-ep-button-b-icon-inner' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .bdt-ep-button .bdt-dual-button-b-icon .bdt-ep-button-b-icon-inner' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-ep-button .bdt-dual-button-b-icon .bdt-ep-button-b-icon-inner' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'types'     => [ 'classic', 'gradient' ],
				'selector'  => '{{WRAPPER}} .bdt-ep-button:hover .bdt-dual-button-b-icon .bdt-ep-button-b-icon-inner',
				'separator' => 'after',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-ep-button:hover .bdt-dual-button-b-icon .bdt-ep-button-b-icon-inner' => 'border-color: {{VALUE}};',
				],
			]
		);
	...
	public function render_text_a($settings) {
		...
		$this->add_render_attribute( 'content-wrapper-a', 'class', 'bdt-ep-button-content-wrapper' );
		...
		$this->add_render_attribute( 'button-a-text', 'class', 'bdt-ep-button-text' );
		...
		<div <?php echo $this->get_render_attribute_string( 'content-wrapper-a' ); ?>>
			<?php if ( ! empty( $settings['button_a_select_icon']['value'] ) ) : ?>
				<div class="bdt-ep-button-icon bdt-dual-button-a-icon bdt-flex-align-<?php echo esc_attr($settings['button_a_icon_align']); ?>">
	...
	public function render_text_b($settings) {
		...
		$this->add_render_attribute( 'content-wrapper-b', 'class', 'bdt-ep-button-content-wrapper' );
		...
		$this->add_render_attribute( 'button-b-text', 'class', 'bdt-ep-button-text' );
		...
		<div <?php echo $this->get_render_attribute_string( 'content-wrapper-b' ); ?>>
			<?php if ( ! empty( $settings['button_b_select_icon']['value'] ) ) : ?>
				<div class="bdt-ep-button-icon bdt-dual-button-b-icon bdt-flex-align-<?php echo esc_attr($settings['button_b_icon_align']); ?>">
	...
	protected function render() {
		...
		$this->add_render_attribute( 'button_a', 'class', 'bdt-dual-button-a bdt-ep-button' );		
		$this->add_render_attribute( 'button_a', 'class', 'bdt-ep-button-effect-' . esc_attr($settings['button_a_effect']) );
		...
		$this->add_render_attribute( 'button_b', 'class', 'bdt-dual-button-b bdt-ep-button' );		
		$this->add_render_attribute( 'button_b', 'class', 'bdt-ep-button-effect-' . esc_attr($settings['button_b_effect']) );
