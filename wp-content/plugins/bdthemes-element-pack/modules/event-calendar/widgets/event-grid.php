 ...
 * Class Post Slider
 */
class Event_Grid extends Module_Base {
	public $_query = null;
	...
	public function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bdt-event-grid-skin-annal .bdt-event-content' => 'background-color: {{VALUE}};',
				],
				'condition' => [
					'_skin' => [ 'annal' ],
				],
	...
	public function render_header($skin_name = 'default') {
		...
		$this->add_render_attribute( 'event-grid', 'class', ['bdt-event-grid', 'bdt-event-calendar', 'bdt-event-grid-skin-' . $skin_name] );
