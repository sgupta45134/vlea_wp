...
Array.prototype.shuffle = function() {
    ...
    return this;
            ...
            switch (this.settings.options.color) {
                ...
                default:
                    if (typeof this.settings.wordColor !== "function") {
                        ...
                        output = this.settings.options.color;
                    } else {
        ...
        updateGrid: function(gx, gy, gw, gh, skipDiffChannel) {
            var x = gw,
                y, imgData = this.ctx.getImageData(gx * this.settings.gridSize, gy * this.settings.gridSize, gw * this.settings.gridSize, gh * this.settings.gridSize);
            while (x--) {
                y = gh;
                while (y--) {
