...
<li title="<?php echo esc_html($install_txt); ?>"><span class="bdt-plugin"></span> Contact 7 Form</li>
<li title="<?php echo esc_html($install_txt); ?>"><span class="bdt-plugin installed"></span> WooCommerce</li>