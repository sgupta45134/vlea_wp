...
Gutenberg post Grid blocks allows you to display latest post, post grid, custom post type, custom taxonomy, content View, post list, popular post and post slider.
...
PostX allows for the seamless creation and customization of Post Blocks, making it perfect for creating News-Based Websites, Magazines, Review Websites, Personal Blogs, Travel Blogs, Fashion Blogs, Viral News, Food Reviews, Recipe Blogs, etc.
...
&#9989; Dynamic Post Slider
&#9989; Post Carousel
&#9989; Custom Post Grid, Custom Post Type Grid, Grid Display, Category Filter, Post Filter, Post Layout, Taxonomy, Custom Taxonomy, Taxonomy Filter and much more.
...
* 1 Gutenberg Blocks for Post Slider
* 88+ Readymade Block Design
* 9+ Starter Packs
...
* RankMath Meta Support Addons [PRO]
* All in One SEO Meta Support Addons [PRO]

### 🏆 Archive Builder (Pro)
Archive Builder is a newly introduced pro feature of PostX for creating customized designs for Archive, Category, Custom Taxonomy, Search & Date Pages.

### 🏆 Custom Taxonomy Query
WordPress custom taxonomy query support for Gutenberg Post Blocks. So you can use any custom post and custom taxonomy inside Gutenberg Blocks.
...
### 🏆 Table of Contents
Add a Customizable Table of Contents blocks into your blog posts and custom post types.
...
### 🏆 AJAX Filter
Category filter is the best element to show many contents in a small place. By clicking category filter users can easily read their interesting content view without reloading any page.
...
<ul>
    ...
    <li><a href="https://ultp.wpxpo.com/taxonomy/" target="_blank">Taxonomy Blocks</a>: Display caustom taxonomy as list or grid in Gutenberg Blocks.</li>
    <li><a href="https://ultp.wpxpo.com/table-of-contents/" target="_blank">Table of Contents</a>: Display Table of Contents into your blog posts.</li>
...
1. Post Grid with Quick Query
2. Post List with Pagination
3. Post Slider
4. Post Module & Filter
5. Layout & Ready Design
