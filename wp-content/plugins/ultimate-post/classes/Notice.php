...
class Notice {
		...
		if (get_transient('ultp_get_pro_notice_v2') != 'off' && (!defined('ULTP_PRO_VER'))) {
            ...
            <div class="wc-install ultp-pro-notice">
				<div class="wc-install-body ultp-image-banner">
                    ...
                    <a class="ultp-btn-image" target="_blank" href="<?php echo ultimate_post()->get_premium_link(); ?>">
                        <img loading="lazy" src="<?php echo ULTP_URL.'assets/img/banner.jpg'; ?>" alt="up to 30% Off" />
                    </a>
                </div>
			</div>
			<?php
	...
	public function ultp_notice_css() {
		...
		<style type="text/css">
            ...
            .ultp-pro-notice .wc-dismiss-notice:hover {
                color: #fff;
                background: #d20d0d;
            }
