...
class Roots_Nav_Walker extends Walker_Nav_Menu {
  function th_check_current($classes) {
...
function roots_nav_menu_args($args = '') {
    ...
    // If there is no walker set, use roots / bootstrap.
    if (!$args['walker'] && (isset($args['menu_class']) && $args['menu_class'] == 'nav navbar-nav')) {
...
add_filter('wp_nav_menu_args', 'roots_nav_menu_args',10, 2);
